...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">
            <p class="lugp">
                Situado em Palmas, a 11 km da Estação Rodoviária de Palmas, o 103 Hotel & Flats oferece acomodações com Wi-Fi gratuito e estacionamento privativo gratuito.
                A propriedade está situada a 1,1 km do Palmas Shopping, a 2,1 km do Palácio Araguaia e a 2,5 km da Praça do Giróis. O hotel dispõe de quartos família.
                Todos os quartos do hotel dispõem de mesa de trabalho, TV de tela plana e banheiro privativo.
                No 103 Hotel & Flats, você pode desfrutar de um buffet de café da manhã.
                A equipe da recepção 24 horas fala inglês e português e terá prazer em fornecer informações práticas sobre a região.
                O Espaço Cultural de Palmas fica a 3,6 km da acomodação, enquanto o Parque Cesamar está a 3,8 km da propriedade. O aeroporto mais próximo é o Aeroporto Brigadeiro Lysias Rodrigues, a 20 km do 103 Hotel & Flats.
            </p>
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="row lugp">
            ...
            <p>&nbsp;&nbsp;Itens de segurança: 7.5</p>
        </div>    
        <div class="row lugp">
            <i class="fas fa-pump-medical"></i>
            <p>&nbsp;&nbsp;&nbsp; Limpeza e desinfecção: 8.5</p>
        </div>
        <div class="row lugp">
            <i class="fas fa-people-arrows"></i>
            <p>&nbsp;&nbsp;Distanciamento físico: 10.0</p>
        </div>
        <div class="row lugp">
            <i class="fas fa-utensils"></i>
            <p>&nbsp;&nbsp;&nbsp;Segurança de alimentos e bebidas: 9.5</p>
        </div>
        <div class="row row-title text-center">
            <div class="col-12">
