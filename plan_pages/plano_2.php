...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row">
            <p class="lugp">
            Localizado em Hjalteyri, a 19 km de Akureyri, o Apt. O Hotel Hjalteyri oferece vista para o mar e para as montanhas a partir de todos os apartamentos.

Todos os quartos possuem TV de tela plana e banheiro privativo.

Você terá acesso a uma banheira de hidromassagem de uso comum e poderá desfrutar de uma bebida na lanchonete. Para sua comodidade, o Wi-Fi em toda a propriedade e o estacionamento privativo no local estão disponíveis, ambos gratuitos.

O apartamento na cobertura tem um terraço privativo e vista de 360 graus das montanhas e do mar.

Famílias particularmente gostam da localização — eles deram nota 9,3 para hospedagem com crianças.
            </p>
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="row lugp">
            ...
            <p>&nbsp;&nbsp;&nbsp;Segurança de alimentos e bebidas: 9.0</p>
        </div>
        <div class="row row-title text-center">
            <div class="col-12">
